...
const NewsSection = () => {
  ...
  return (
    <section className={styles.news}>
      <h2>Latest News</h2>
      <p>Stay updated with the latest trends and insights in the world of board games, card games, and dice games.</p>
      <div className={styles.newsGrid}>
        {newsFeed?.items.slice(0, 3).map(({ pubDate, creator, title, link }, index) => (
