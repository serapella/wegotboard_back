      ...
      <div className={styles["tab-content"]}>
        ...
        <TabContent isActive={activeTab === "information"}>
          ...
          <ul className={styles["component-list"]}>
            ...
            <li>
              Players: {product?.playerCount.min || 0}-
              {product?.playerCount.max || 0}
            </li>
            <li>
              Difficulty: {product?.difficulty || "No difficulty specified"}
            </li>
            <li>Duration: {product?.duration || "No duration specified"}</li>
            <li>
              Category: {product?.category.name || "No category specified"}
            </li>
          </ul>
